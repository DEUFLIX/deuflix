...
const Account = () => {
    ...
    const sidebarItems = [
        ...
        { text: '보안', icon: faShieldAlt, link: '#' },
        { text: '프로필', icon: faUser, link: '#' },
    ];
        ...
        <Layout sidebarItems={sidebarItems}>
            ...
            <section className={`${styles.profileManagement} p-6 border rounded-lg`}>
                ...
                <div className={`${styles.profileIcons} flex space-x-4`}>
                    <img src="/images/profile1.png" alt="Profile 1" className={styles.profileIconsImg}/>
                    <img src="/images/profile2.png" alt="Profile 2" className={styles.profileIconsImg}/>
                    <img src="/images/profile3.png" alt="Profile 3" className={styles.profileIconsImg}/>
                </div>
            </section>
        </Layout>
    );
