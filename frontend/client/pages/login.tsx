      ...
      <div className="relative flex flex-col min-h-screen w-full">
        ...
        <div className="w-full bg-black py-16 text-white">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-4">
            <div className="w-full md:w-1/2">
              <h3 className="font-semibold text-3xl mb-4 text-center md:text-left">TV로 즐기세요</h3>
              <p className="text-center md:text-left">스마트 TV, PlayStation, Xbox, Chromecast, Apple TV, 블루레이 플레이어 등 다양한 디바이스에서 시청하세요.</p>
            </div>
            <video
                src="/login_1.m4v"
                autoPlay
        ...
        <div className="w-full bg-black py-16 text-white mt-2">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-4">
            ...
            />
            <div className="w-full md:w-1/2">
              <h3 className="font-semibold text-3xl mb-4 text-center md:text-left">어디서나 자유롭게 시청하세요</h3>
              <p className="text-center md:text-left">각종 영화와 시리즈를 스마트폰, 태블릿, 노트북, TV에서 무제한으로 스트리밍하세요.</p>
            </div>
          </div>
        </div>
        <div className="w-full bg-black py-16 text-white mt-2">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-4">
            <div className="w-full md:w-1/2">
              <h3 className="font-semibold text-3xl mb-4 text-center md:text-left">어린이 전용 프로필을 만들어 보세요</h3>
              <p className="text-center md:text-left">자기만의 공간에서 좋아하는 캐릭터와 즐기는 신나는 모험. 자녀에게 이 특별한 경험을 선물하세요. 넷플릭스 회원이라면
                무료입니다.</p>
            </div>
            <img
                src="/login_3.png"
        ...
        <div className="w-full bg-black py-16 text-white mt-2">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-4">
            ...
            />
            <div className="w-full md:w-1/2">
              <h3 className="font-semibold text-3xl mb-4 text-center md:text-left">즐겨 보는 콘텐츠를 저장해 오프라인으로 시청하세요</h3>
              <p className="text-center md:text-left">비행기, 기차, 잠수함. 어디서든 시청하세요.</p>
            </div>
          </div>
        </div>
        {/* 추가된 섹션 끝 */}
        ...
        <div className="w-full bg-black py-16 text-white mt-2">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl font-semibold mb-6 text-center">자주 묻는 질문</h2>
            <div className="space-y-4">
